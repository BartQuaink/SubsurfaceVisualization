...
require([
        ...
        view.when(function() {
            ...
            geoTOPv2.parent.ground.opacity = 0;
          ...
          function updateVerticalExag(value) {
              // log to see if functions is called
              console.log("Hello");

              // get value and alter height of symbology
              var geoTOP = scene.layers.getItemAt(0);

              // Initiate renderer
              var renderclone = geoTOP.renderer.clone();
              console.log(renderclone.visualVariables);
              var renderer = {
                //
              };
